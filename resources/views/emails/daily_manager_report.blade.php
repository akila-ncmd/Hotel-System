...
<body>
    ...
    <ul>
        ...
        <li><strong>Check-Out Revenue:</strong> @money($data['check_out_revenue'])</li>
        <li><strong>No-Show Revenue:</strong> @money($data['no_show_revenue'])</li>
        <li><strong>Total Revenue:</strong> @money($data['total_revenue'])</li>
        <li><strong>No-Shows:</strong> {{ $data['no_shows'] }}</li>
    </ul>
    <p>The detailed report is attached as a PDF.</p>
    <p>Best regards,<br>{{ config('app.name', 'Diamond Shine') }}</p>
</body>
</html>